...
export default async function FbsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const assessment: ReportAssessment = {
    ...
    gripRightKg: a.gripRightKg ?? undefined,
    gripLeftKg: a.gripLeftKg ?? undefined,
    // Power
    verticalJumpBothCm: a.verticalJumpBothCm ?? undefined,
    verticalJumpRightCm: a.verticalJumpRightCm ?? undefined,
    verticalJumpLeftCm: a.verticalJumpLeftCm ?? undefined,
    medicineBallThrowBackM: a.medicineBallThrowBackM ?? undefined,
    benchPressKg: a.benchPressKg ?? undefined,
    sprint10mSec: a.sprint10mSec ?? undefined,
    sprint30mSec: a.sprint30mSec ?? undefined,
    ballVelocityKmh: a.ballVelocityKmh ?? undefined,
    // Strength
    strength2ndErRight: a.strength2ndErRight ?? undefined,
    strength2ndErLeft: a.strength2ndErLeft ?? undefined,
    strength2ndIrRight: a.strength2ndIrRight ?? undefined,
    strength2ndIrLeft: a.strength2ndIrLeft ?? undefined,
    strengthBellyPressRight: a.strengthBellyPressRight ?? undefined,
    strengthBellyPressLeft: a.strengthBellyPressLeft ?? undefined,
    strengthSerratusAnteriorRight: a.strengthSerratusAnteriorRight ?? undefined,
    strengthSerratusAnteriorLeft: a.strengthSerratusAnteriorLeft ?? undefined,
    strengthLowerTrapeziusRight: a.strengthLowerTrapeziusRight ?? undefined,
    strengthLowerTrapeziusLeft: a.strengthLowerTrapeziusLeft ?? undefined,
    strengthHipFlexionRight: a.strengthHipFlexionRight ?? undefined,
    strengthHipFlexionLeft: a.strengthHipFlexionLeft ?? undefined,
    strengthHipExtensionRight: a.strengthHipExtensionRight ?? undefined,
    strengthHipExtensionLeft: a.strengthHipExtensionLeft ?? undefined,
    strengthHipAbductionRight: a.strengthHipAbductionRight ?? undefined,
    strengthHipAbductionLeft: a.strengthHipAbductionLeft ?? undefined,
    strengthHipAdductionRight: a.strengthHipAdductionRight ?? undefined,
    strengthHipAdductionLeft: a.strengthHipAdductionLeft ?? undefined,
    strengthHipErRight: a.strengthHipErRight ?? undefined,
    strengthHipErLeft: a.strengthHipErLeft ?? undefined,
    strengthHipIrRight: a.strengthHipIrRight ?? undefined,
    strengthHipIrLeft: a.strengthHipIrLeft ?? undefined,
  };
