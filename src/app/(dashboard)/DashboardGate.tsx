        ...
        <CardContent className="space-y-4">
          {!authed ? (
            <form action={loginAction} className="flex gap-3">
              <Button type="submit" className="min-w-28">ログイン</Button>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                <Button asChild className="min-w-32"><Link href="/athletes">選手一覧へ</Link></Button>
                <Button asChild variant="outline" className="min-w-32 border-black/40"><Link href="/billing">サブスク管理へ</Link></Button>
